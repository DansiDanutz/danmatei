...
export default defineConfig({
    ...
    rollupOptions: {
      ...
      output: {
        manualChunks: {
          ...
          livekitReact: ["@livekit/components-react"],
          ui: [
            "@radix-ui/react-tabs",
  ...
  server: {
    // Port 3000 is commonly squatted by Grafana / Next.js / Rails;
    // pick 3030 by default and let `PORT=...` override.
